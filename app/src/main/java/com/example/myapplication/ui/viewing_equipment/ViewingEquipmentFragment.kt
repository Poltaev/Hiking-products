...
class ViewingEquipmentFragment : Fragment() {
    ...
    private var _binding: FragmentViewingEquipmentBinding? = null
    ...
    private val viewModel: ViewingEquipmentViewModel by viewModels{
        object : ViewModelProvider.Factory {
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                ...
                return ViewingEquipmentViewModel(hikeDao) as T
            }
        }
    }
    override fun onCreateView(
        ...
        _binding = FragmentViewingEquipmentBinding.inflate(inflater, container, false)
